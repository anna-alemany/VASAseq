...
if timepoint == 'E65':
    sample_out = []
    reads_su_th = {'All': [10**4,10**6]}; reads_s_th = {'All': [10**4, 10**5], 'smallRNA': [10**3,10**5]}
    genes_su_th = {'All': [5000, 17000]}; genes_s_th = {'All': [10**3.5, 10**4.5]}
    fracs_su_th = {'ProteinCoding': [.85,.95], 'lncRNA': [.01,.03], 'smallRNA': [.02,0.15]}; fracs_s_th = {}
    n_pca = 20
    ...
    sample_out = []
    reads_su_th = {'All': [10**3.5,10**6]}; reads_s_th = {}
    genes_su_th = {'All': [3100, 15000]}; genes_s_th = {'All': [2400,10000]}
    fracs_su_th = {'ProteinCoding': [.85,.95], 'lncRNA': [.01,.03], 'smallRNA': [.02,0.15]}; fracs_s_th = {}
    n_pca = 40 
    ...
    reads_su_th = {'All': [10**3.5,10**6]}; reads_s_th = {'All': [10**3,10**5]}
    genes_su_th = {'All': [2500, 15000]}; genes_s_th = {'All': [2400,10000]}
    fracs_su_th = {'ProteinCoding': [.85,.95], 'lncRNA': [.01,.03], 'smallRNA': [.02,0.15]}; fracs_s_th = {}
    n_pca = 40
    resolution_s = {'All': 1, 'ProteinCoding': 1, 'lncRNA': 1, 'smallRNA': 0.75, 'TF': 1, 'Cofactor': 0.75}
    resolution_su =  {'All': 1, 'ProteinCoding': 1, 'lncRNA': 1, 'smallRNA': 0.75, 'TF': 1, 'Cofactor': 0.75}
    ...
    genes_su_th = {'All': [2500, 15000]}; genes_s_th = {'All': [2300,10000]}
    fracs_su_th = {'ProteinCoding': [.85,.95], 'lncRNA': [.012,.03], 'smallRNA': [.02,0.15]}; fracs_s_th = {}
    n_pca = 40
    resolution_s = {'All': 1, 'ProteinCoding': 1, 'lncRNA': 1, 'smallRNA': 0.75, 'TF': 1, 'Cofactor': 0.75}
    resolution_su = {'All': 1, 'ProteinCoding': 1, 'lncRNA': 1, 'smallRNA': 0.75, 'TF': 1, 'Cofactor': 0.75}
    min_disp = 0.5

outdir = '../'+timepoint+'/res_scanpy_all_2021_v2'
...
adata_su = filter_BiotypeThresholds(adata_su, reads_su_th, genes_su_th, fracs_su_th, sample_out)
